...
﻿            double npv_24700_put = Black76GreeksCalculator.Instance.NPV ( ProductType.Option, false, forwardPrice, 24700, rfr, timeToExpiry, black76PriceSpaceVolSurface);
﻿            Console.WriteLine($"npv at 24700 strike: {npv_24700_put}");
﻿
﻿
﻿            double gamma_24700 = Black76GreeksCalculator.Instance.Gamma(ProductType.Option, false, forwardPrice, 24700, rfr, timeToExpiry, black76PriceSpaceVolSurface);
﻿            Console.WriteLine($"gamma at 24700 strike: {gamma_24700}");
﻿
﻿            double npv_up = Black76GreeksCalculator.Instance.NPV ( ProductType.Option, false, forwardPrice * (1 + bump), 24700, rfr, timeToExpiry, black76PriceSpaceVolSurface);
...
﻿            double npv_down = Black76GreeksCalculator.Instance.NPV ( ProductType.Option, false, forwardPrice * (1 - bump), 24700, rfr, timeToExpiry, black76PriceSpaceVolSurface);
...
﻿
﻿            double gamma_25000 = Black76GreeksCalculator.Instance.Gamma(ProductType.Option, false, forwardPrice, 25000, rfr, timeToExpiry, black76PriceSpaceVolSurface);
﻿            Console.WriteLine($"gamma at 25000 strike: {gamma_25000}");
﻿            double gamma_25100 = Black76GreeksCalculator.Instance.Gamma(ProductType.Option, false, forwardPrice, 25100, rfr, timeToExpiry, black76PriceSpaceVolSurface);
﻿            Console.WriteLine($"gamma at 25100 strike: {gamma_25100}");
﻿            double gamma_25200 = Black76GreeksCalculator.Instance.Gamma(ProductType.Option, false, forwardPrice, 25200, rfr, timeToExpiry, black76PriceSpaceVolSurface);
﻿            Console.WriteLine($"gamma at 25200 strike: {gamma_25200}");
﻿            double gamma_25300 = Black76GreeksCalculator.Instance.Gamma(ProductType.Option, false, forwardPrice, 25300, rfr, timeToExpiry, black76PriceSpaceVolSurface);
﻿            Console.WriteLine($"gamma at 25300 strike: {gamma_25300}");
﻿            double gamma_26800 = Black76GreeksCalculator.Instance.Gamma(ProductType.Option, false, forwardPrice, 26800, rfr, timeToExpiry, black76PriceSpaceVolSurface);
﻿            Console.WriteLine($"gamma at 26800 strike: {gamma_26800}");
﻿            double gamma_26900 = Black76GreeksCalculator.Instance.Gamma(ProductType.Option, false, forwardPrice, 26900, rfr, timeToExpiry, black76PriceSpaceVolSurface);
﻿            Console.WriteLine($"gamma at 26900 strike: {gamma_26900}");
﻿            double gamma_27000 = Black76GreeksCalculator.Instance.Gamma(ProductType.Option, false, forwardPrice, 27000, rfr, timeToExpiry, black76PriceSpaceVolSurface);
﻿            Console.WriteLine($"gamma at 27000 strike:. {gamma_27000}");
﻿            double gamma_27100 = Black76GreeksCalculator.Instance.Gamma(ProductType.Option, false, forwardPrice, 27100, rfr, timeToExpiry, black76PriceSpaceVolSurface);
﻿            Console.WriteLine($"gamma at 27100 strike: {gamma_27100}");
﻿            double gamma_27200 = Black76GreeksCalculator.Instance.Gamma(ProductType.Option, false, forwardPrice, 27200, rfr, timeToExpiry, black76PriceSpaceVolSurface);
